...
define('PRESENTATION_DIR', SITE_ROOT .DS. 'presentation'.DS);
define('BUSINESS_DIR', SITE_ROOT . DS.'business'.DS);
// Settings needed to configure the Smarty template engine
define('SMARTY_DIR', SITE_ROOT . DS. 'libs'.DS.'smarty'.DS);
define('TEMPLATE_DIR', PRESENTATION_DIR . 'templates');
define('COMPILE_DIR', PRESENTATION_DIR . 'templates_c');
define('CONFIG_DIR', SITE_ROOT .DS. 'include'.DS.'configs');
...
define('LOG_ERRORS_FILE', SITE_ROOT.DS.'errors_log.txt'); // Windows
